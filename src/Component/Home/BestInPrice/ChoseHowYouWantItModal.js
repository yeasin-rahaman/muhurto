                            ...
                            <div class="container-fluid">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 ms-auto">
                                        <h3>Choose how you want it</h3>
                                        <ul>
                                            <li>You can customize any package</li>
                                            <li>You can add any service to your package</li>
                                            <li>You can choose and create a suitable package or service the way you want it</li>
                                        </ul>
                                        <p>
