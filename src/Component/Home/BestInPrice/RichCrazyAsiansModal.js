...
const RichCrazyAsiansModal = () => {
    return (
        <div className="priceModal">
            <div class="modal fade" id="RichCrazyAsiansModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="RichCrazyAsiansModalLabel" aria-hidden="true">
                            ...
                            <div class="container-fluid">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 ms-auto">
                                        <h3>𝐑𝐢𝐜𝐡 𝐂𝐫𝐚𝐳𝐲 𝐀𝐬𝐢𝐚𝐧</h3>
                                        <p> We recommend this Package for those who are looking for something out of the ordinary premium services.
                                        </p>
                                        ...
                                        <p>� On Event Day</p>
                                        <ul>
                                            <li>Chief Photographer</li>
                                            <li>2 Senior Photographer</li>
                                        ...
                                        <ul>
                                            ...
                                            <li>100 copies Advance Edited and Printed (50 Copies 4R+50 Copies 5L+ 10L 5 Copies)</li>
                                        </ul>
                                        <h5>Movie:</h5>
                                        <ul>
                                            <li>2-3 minutes premium edited Cinematic Movie Trailer.</li>
                                        ...
                                        <h3 className='d-flex justify-content-end mt-5'>BDT 75,000 Only</h3>
...
export default RichCrazyAsiansModal;