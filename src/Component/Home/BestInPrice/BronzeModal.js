...
const BronzeModal = () => {
    return (
        <div class="modal fade" id="BronzeModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="BronzeModalLabel" aria-hidden="true">
